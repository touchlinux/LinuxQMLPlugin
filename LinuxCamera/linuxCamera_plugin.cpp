...
#include "linuxCamera_plugin.h"
#include "linuxCamera.h"

void LinuxV4L2Plugin::registerTypes(const char *uri)
{
    // @uri com.touchlinux.qmlcomponents
    qmlRegisterType<LinuxCamera>(uri, 1, 0, "LinuxCamera");
}

Q_EXPORT_PLUGIN2(LinuxCamera, LinuxCamera)
